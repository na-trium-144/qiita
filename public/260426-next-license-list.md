...
手動でnpmパッケージのリストを作りライセンス本文を転記し、また忘れずに更新するというのは非現実的です。Next.js側にもこれを自動でやってくれる機能は用意されていません。(ちなみにDiscussionはありました: [vercel/next.js#33588](https://github.com/vercel/next.js/discussions/33588))
